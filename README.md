...
Let a moderator know that you would like to complete a ticket. Once approved, you can begin working on the ticket.
...
In the Pull Requests tab, click New Pull Request, then select your feature branch from the compare dropdown. Write a name and description for the request, then click Create Pull Request.
